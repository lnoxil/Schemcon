...
Для FAWE при копировании в папку `schematics` выполняется приведение к Sponge-совместимому формату (если исходник был region/litematic-подобным), чтобы `//schem load` видел файл.
